...
const elem = document.querySelector(`[data-slidev-no="212"] h1`)
...
```js {monaco-run}
const elem = document.querySelector(`[data-slidev-no="214"] h1`)
...
const link = document.querySelector(`[data-slidev-no="218"] a`)
...
```js {monaco-run}
const h1 = document.querySelector(`[data-slidev-no="218"] h1`)
...
```js {monaco-run}{autorun: false}
const element = document.querySelector(`[data-slidev-no="220"] h1`)
