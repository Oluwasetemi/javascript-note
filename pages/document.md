...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="188"]`)
...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="190"]`)
...
const table = document.querySelector(`[data-slidev-no="191"]`)
console.log(table);
...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="193"]`);
...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="194"]`);
...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="195"]`);
...
const element = document.querySelector(`[data-slidev-no="197"] .default`);
element.prepend(div);
```
...
const element = document.querySelector(`[data-slidev-no="198"] .default`);
...
const element = document.querySelector(`[data-slidev-no="199"]`);
...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="200"] .view-lines`);
...
const element = document.querySelector(`[data-slidev-no="204"] h1`);
