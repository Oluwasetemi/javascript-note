...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="180"]`)
...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="182"]`)
...
const table = document.querySelector(`[data-slidev-no="183"]`)
console.log(table);
...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="185"]`);
...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="186"]`);
...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="187"]`);
...
const element = document.querySelector(`[data-slidev-no="189"] .default`);
element.prepend(div);
```
...
const element = document.querySelector(`[data-slidev-no="190"] .default`);
...
const element = document.querySelector(`[data-slidev-no="191"]`);
...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="192"] .view-lines`);
...
const element = document.querySelector(`[data-slidev-no="196"] h1`);
