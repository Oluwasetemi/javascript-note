...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="58"]`)
...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="60"]`)
...
const table = document.querySelector(`[data-slidev-no="61"]`)
console.log(table);
...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="63"]`);
...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="64"]`);
...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="65"]`);
...
element.setAttribute('data-slidev-no', '65'); console.log(element.dataset.slidevNo);
...
const element = document.querySelector(`[data-slidev-no="67"] .default`);
element.prepend(div);
```
...
const element = document.querySelector(`[data-slidev-no="68"] .default`);
...
const element = document.querySelector(`[data-slidev-no="69"]`);
