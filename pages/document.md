...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="157"]`)
...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="159"]`)
...
const table = document.querySelector(`[data-slidev-no="160"]`)
console.log(table);
...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="162"]`);
...
const element = document.querySelector(`[data-slidev-no="166"] .default`);
element.prepend(div);
```
...
const element = document.querySelector(`[data-slidev-no="168"]`);
...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="169"] .view-lines`);
...
const element = document.querySelector(`[data-slidev-no="173"] h1`);
