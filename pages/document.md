...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="91"]`)
...
const table = document.querySelector(`[data-slidev-no="92"]`)
console.log(table);
...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="96"]`);
...
const element = document.querySelector(`[data-slidev-no="99"] .default`);
...
```js{monaco-run} {autorun: false}
const element = document.querySelector(`[data-slidev-no="101"] .view-lines`);
...
const element = document.querySelector(`[data-slidev-no="105"] h1`);
